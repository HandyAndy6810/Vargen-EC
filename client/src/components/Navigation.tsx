...
export function BottomNav() {
  ...
  return (
    <div className="fixed bottom-8 left-1/2 -translate-x-1/2 z-[100] pointer-events-none">
      <nav className="bg-white/95 backdrop-blur-xl border border-black/5 rounded-full px-6 py-3 flex items-center gap-8 shadow-[0_20px_50px_rgba(0,0,0,0.1)] pointer-events-auto transition-all duration-300 hover:scale-[1.02]">
        {navItems.map((item) => {
